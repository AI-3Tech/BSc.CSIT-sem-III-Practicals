...
int main()
{
    ...
    outtextxy(x1+xmid, ymid-y1-y2-20, (char*)"ORIGINAL TRIANGLE");
    ...
    switch( option)
    {
        case 1:  
            ...
            y2=-y2;
            y3=-y3; 
            outtextxy(x1+xmid, ymid-y1-20, (char*)"REFLECTED ABOUT X-AXIS");
            break; 
        ...
        case 2:  
            ...
            x2=-x2;
            x3=-x3;
            outtextxy(x1+x2+x3+xmid, ymid-y1-y2-20, (char*)"REFLECTED ABOUT Y-AXIS");
            break;
        ...
        /*case 3:
            ...
            y2 = -y2;
            y3 = -y3;
            theta = ((double)45 * 3.14f) / (double)180;
